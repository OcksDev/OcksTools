                    ...
                    switch (command[1])
                    {
                        case "edit":
                            if (command[2] != "")
                            {
                                ...
                                SaveSystem.Instance.SaveString(command_caps[2], eee);
                        ...
                        case "read":
                            if (command[2] != "")
                            {
                                ConsoleLol.Instance.ConsoleLog($"{SaveSystem.Instance.LoadString(command_caps[2], lang.IndexValuePairs["Error_NoData"])}");
                            }
                            else
                            {
                                ConsoleLol.Instance.ConsoleLog(lang.IndexValuePairs["Error_NoReg"], "#ff0000ff");
                        ...
                        case "listall":
                            ...
                            {
                                ConsoleLol.Instance.ConsoleLog($"{FileSystem.Instance.ReadFile(SaveSystem.Instance.GameFilePath)}");
                            }
                            else
                            {
