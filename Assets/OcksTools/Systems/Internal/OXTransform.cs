...
public static class _ApplyTransforms
{
    ...
    public static void SetPositionOX(this OXTransform ox, Transform t) => ox.Position = t.position;
    public static void SetLocalPositionOX(this OXTransform ox, Transform t) => ox.Position = t.localPosition;
    public static void SetRotationOX(this OXTransform ox, Transform t) => ox.Rotation = t.rotation;
    public static void SetLocalRotationOX(this OXTransform ox, Transform t) => ox.Rotation = t.localRotation;
    public static void SetScaleOX(this OXTransformWithScale ox, Transform t) => ox.Scale = t.localScale;
    public static void ModPositionOX(this OXTransform ox, Transform t) => ox.Position += t.position;
    public static void ModLocalPositionOX(this OXTransform ox, Transform t) => ox.Position += t.localPosition;
    public static void ModRotationOX(this OXTransform ox, Transform t) => ox.Rotation *= t.rotation;
    public static void ModLocalRotationOX(this OXTransform ox, Transform t) => ox.Rotation *= t.localRotation;
    public static void ModScaleOX(this OXTransformWithScale ox, Transform t)
    {
        ox.Scale.x *= t.localScale.x;
        ox.Scale.y *= t.localScale.y;
        ox.Scale.z *= t.localScale.z;
    }
    ...
    public static void LerpT(this OXTransform target, Transform val, float perc)
    {
        ...
        target.Rotation = target.Rotation.SlerpT(val.rotation, perc);
    }
    ...
    public static void LerpT(this OXTransformWithScale target, Transform val, float perc)
    {
        target.Position = target.Position.LerpT(val.position, perc);
        target.Rotation = target.Rotation.SlerpT(val.rotation, perc);
        target.Scale = target.Scale.LerpT(val.localScale, perc);
    }
